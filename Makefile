...
$(TARGET).blif: canUnstuff.v canCRC.v spiSlave.v packetCapture.v baudclock.v top.v
	yosys -q -p "synth_ice40 -blif $(TARGET).blif" canUnstuff.v canCRC.v spiSlave.v packetCapture.v baudclock.v top.v
